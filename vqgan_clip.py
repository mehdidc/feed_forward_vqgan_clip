...
# texts = "This plant is called 'Sensevieria trifasciata'. This plant look like a snake. This plant have thick leaves featuring dark green with light green markings.  Beautiful colors. | unreal engine" #@param {type:"string"}
texts = "A portal to the stars in an empty ruin, in the style of a Renaissance painting"
...
max_iterations = 550#@param {type:"number"}
...
# print(z.shape)
# import stylegan
# net = stylegan.SG(image_size=32, latent_dim=512, nb_channels=256, truncate=18)
