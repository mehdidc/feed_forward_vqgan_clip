...
- **04-07-2022**
    - Version 0.4 released: new models that can be tried in the [notebook](https://colab.research.google.com/drive/1N8vvdhkvLaMefTIW_WYuJa-FflqyBnHr?usp=sharing) and on [Replicate](https://replicate.ai/mehdidc/feed_forward_vqgan_clip)). See also the release [here](https://github.com/mehdidc/feed_forward_vqgan_clip#pre-trained-models)
